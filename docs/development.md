...
This guide contains information to help onboard developers to work on the [LEMP](https://en.wikipedia.org/wiki/LAMP_%28software_bundle%29) integration, hereafter referred to as "the plugin".
